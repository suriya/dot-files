...
" License:      Vim License
"
" $Id: MultipleSearch.vim 403 2005-07-01 02:00:47Z suriya $
"
...
function! s:MultipleSearchInit()
    ...
    if exists('g:MultipleSearchColorSequence')
        ...
        let s:ColorSequence = "red,blue,green,magenta,cyan,gray,brown,yellow"
    endif
    ...
    if exists('g:MultipleSearchTextColorSequence')
        ...
        let s:TextColorSequence = "white,white,white,white,white,white,white,white"
    endif
